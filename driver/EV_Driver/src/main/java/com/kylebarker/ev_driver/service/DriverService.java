...
public class DriverService 
{
    ...
    {
        if (simRunning.get()) return new SimulationStatusDto(true, "already_running");
        ...
        simTask = scheduler.scheduleAtFixedRate(new Runnable() 
        {
            ...
            @Override public void run() {
                try {
                    ...
                    if (line == null) { stopSimulation(); br.close(); return; }
                ...
                } catch (Exception e) { stopSimulation(); }
            }
    ...
    {
        if (simTask != null) simTask.cancel(true);
        ...
        try (Socket sock = new Socket())
         {
            ...
            ChargeRequestStatusDto cur = requests.get(reqId);
            if (cur != null) cur.setStatus("ERROR");
        }
    }
}
